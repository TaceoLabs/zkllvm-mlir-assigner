...
namespace nil {
    namespace blueprint {
        ...
        void handle_gather(
            ...
            instance_input.d_eq = stack.get_local(operation.getDEq());
            instance_input.d_neq = stack.get_local(operation.getDNeq());
            instance_input.index_a = stack.get_local(operation.getCmpSet());

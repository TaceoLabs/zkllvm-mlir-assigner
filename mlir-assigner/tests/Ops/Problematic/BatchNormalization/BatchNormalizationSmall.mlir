module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-pc-linux-gnu", "onnx-mlir.symbol-postfix" = "batchnormalizationsmall.mlir"} {
  func.func @main_graph(%arg0: memref<1x8x2x2xf32>, %arg1: memref<8xf32>, %arg2: memref<8xf32>) -> memref<1x8x2x2xf32> attributes {input_names = ["in_a", "in_d", "in_e"], llvm.emit_c_interface, output_names = ["out_a"]} {
    ...
    %alloc_0 = memref.alloc() {alignment = 16 : i64} : memref<1x8x2x2xf32>
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 8 {
        affine.for %arg5 = 0 to 2 {
          affine.for %arg6 = 0 to 2 {
            %3 = affine.load %arg0[%c0, %arg4, %arg5, %arg6] : memref<1x8x2x2xf32>
            %4 = affine.load %reinterpret_cast[%arg4, %c0, %c0] : memref<8x1x1xf32>
            %5 = arith.mulf %3, %4 : f32
            affine.store %5, %alloc_0[%arg3, %arg4, %arg5, %arg6] : memref<1x8x2x2xf32>
          }
        }
      }
    }
    ...
    %alloc_3 = memref.alloc() {alignment = 16 : i64} : memref<1x8x2x2xf32>
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 8 {
        affine.for %arg5 = 0 to 2 {
          affine.for %arg6 = 0 to 2 {
            %3 = affine.load %alloc_0[%c0, %arg4, %arg5, %arg6] : memref<1x8x2x2xf32>
            %4 = affine.load %reinterpret_cast_2[%arg4, %c0, %c0] : memref<8x1x1xf32>
            %5 = arith.addf %3, %4 : f32
            affine.store %5, %alloc_3[%arg3, %arg4, %arg5, %arg6] : memref<1x8x2x2xf32>
          }
        }
      }
    }
    return %alloc_3 : memref<1x8x2x2xf32>
  }
  "krnl.entry_point"() {func = @main_graph, numInputs = 3 : i32, numOutputs = 1 : i32, signature = "[    { \22type\22 : \22f32\22 , \22dims\22 : [1 , 8 , 2 , 2] , \22name\22 : \22in_a\22 }\0A ,    { \22type\22 : \22f32\22 , \22dims\22 : [8] , \22name\22 : \22in_d\22 }\0A ,    { \22type\22 : \22f32\22 , \22dims\22 : [8] , \22name\22 : \22in_e\22 }\0A\0A]\00@[   { \22type\22 : \22f32\22 , \22dims\22 : [1 , 8 , 2 , 2] , \22name\22 : \22out_a\22 }\0A\0A]\00"} : () -> ()
}

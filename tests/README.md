...
| **LogSoftmax**                | none                         | Axis 0, 1, and default currently disabled due to changes in ONNX 1.8.1/Opset 13.                                                                   | :heavy_check_mark: |
...
| **ReduceSum**                 | none                         | Default axis and do_not_keep_dim not supported.                                                                                                    | :heavy_check_mark: |
...
| **Scan**                      | none                         | Does not support dynamic shapes.                                                                                                                   | :heavy_check_mark: |
...
| **Slice**                     | none                         | Axis must be a constant argument.                                                                                                                  | :heavy_check_mark: |
...
| **SpaceToDepth**              | none                         |                                                                                                                                                    | :heavy_check_mark: |
| **Split**                     | none                         | Does not support static and dynamic shape, zero size splits.                                                                                       | :heavy_check_mark: |
| **SplitToSequence**           | none                         |                                                                                                                                                    | :heavy_check_mark: |
| **Sqrt**                      | none                         |                                                                                                                                                    | :heavy_check_mark: |
| **Squeeze**                   | none                         | Does not support static and dynamic shape.                                                                                                         | :heavy_check_mark: |
...
| **Unsqueeze**                 | none                         | Does not support static and dynamic shape.                                                                                                         | :heavy_check_mark: |

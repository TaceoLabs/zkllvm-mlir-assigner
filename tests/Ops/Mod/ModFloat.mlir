module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "onnx-mlir.symbol-postfix" = "modfloat.0.mlir"} {
  func.func @main_graph(%arg0: memref<1x10xf32>, %arg1: memref<1x10xf32>) -> memref<1x10xf32> attributes {input_names = ["in_a", "in_b"], llvm.emit_c_interface, output_names = ["out_a"]} {
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 10 {
        ...
        %2 = arith.remf %0, %1 : f32
        %3 = math.copysign %2, %0 : f32
        affine.store %3, %alloc[%arg2, %arg3] : memref<1x10xf32>
      }
    }

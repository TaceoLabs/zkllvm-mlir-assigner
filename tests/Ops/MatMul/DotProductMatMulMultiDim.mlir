    ...
    affine.for %arg2 = 0 to 12 {
      affine.for %arg3 = 0 to 8 {
        affine.for %arg4 = 0 to 32 {
          ...
          affine.store %1, %alloc_0[%arg4] : memref<32xf32>
          affine.store %2, %alloc_1[%arg4] : memref<32xf32>
        }
        %0 = "zkML.dot-product"(%alloc_0, %alloc_1) : (memref<32xf32>, memref<32xf32>) -> f32
        affine.store %0, %alloc[%arg2, %arg3] : memref<12x8xf32>
      }
    }
    memref.dealloc %alloc_0 : memref<32xf32>
